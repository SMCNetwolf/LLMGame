...
SIDE_QUESTS = [
    {
        ...
        "description": "Um lobo feroz tem aterrorizado os fazendeiros locais. O prefeito oferece uma recompensa para quem resolver este problema.",
    ...
    },
    {
        ...
        "description": "A curandeira da vila precisa de ervas raras que crescem na Floresta Negra para preparar remédios para os doentes.",
...
def generate_quest_prompt(quest_id, character_name):
    ...
    prompt += "Crie um diálogo imersivo entre você e o NPC sobre esta missão."
