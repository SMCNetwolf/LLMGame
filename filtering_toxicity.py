...
REJECTION_RESPONSES = {
    "general": "Sua solicitação não pode ser processada pois contém conteúdo inadequado para este jogo. Por favor, tente novamente com uma abordagem diferente.",
    "violent": "Sua solicitação contém violência excessiva que vai além da temática do jogo. Por favor, tente uma abordagem mais adequada para um jogo de fantasia medieval.",
    "offensive": "Seu comando contém linguagem ofensiva ou inapropriada. Este jogo é destinado a ser uma experiência positiva e inclusiva para todos.",
    "out_of_context": "Sua solicitação se afasta demais do tema de fantasia medieval deste jogo. Por favor, mantenha suas ações dentro do contexto do mundo do jogo."
}
